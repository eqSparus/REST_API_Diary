...
class DiaryControllerTest {
    ...
    @Autowired
    public DiaryControllerTest(WebApplicationContext wac, TokenCreator creator) {
        this.wac = wac;
    ...
    void createDiary() throws Exception {
        ...
        var diary = new DiaryForm("Diary");

        mvc.perform(post("/crud/diary/create")
                        .content(mapper.writeValueAsString(diary)).contentType(MediaType.APPLICATION_JSON_VALUE)
